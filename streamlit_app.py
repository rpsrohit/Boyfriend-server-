...
ADMIN_CHAT_ID = "9674758561"                 # ← yahaan real chat ID daalo
...
st.markdown('<div class="footer">Made with 👑☠️ by MADHAV PAPA HERE  | © 2026</div>', unsafe_allow_html=True)
